...
DR_DECLARE_ANNOTATION(test_annotation_eight_args) (unsigned int a,
    unsigned int b, unsigned int c, unsigned int d, unsigned int e,
    unsigned int f, unsigned int g, unsigned int h)
    DR_WEAK_DECLARATION;

DR_DECLARE_ANNOTATION(test_annotation_nine_args) (unsigned int a,
    unsigned int b, unsigned int c, unsigned int d, unsigned int e,
    unsigned int f, unsigned int g, unsigned int h, unsigned int i)
    DR_WEAK_DECLARATION;

DR_DECLARE_ANNOTATION(test_annotation_ten_args) (unsigned int a,
    unsigned int b, unsigned int c, unsigned int d, unsigned int e,
    unsigned int f, unsigned int g, unsigned int h, unsigned int i,
