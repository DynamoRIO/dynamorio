...
The summaries below provide a high-level overview of each sample to help
users identify relevant starting points; implementation details remain
...
Note: This file provides shared utilities used by multiple samples rather
