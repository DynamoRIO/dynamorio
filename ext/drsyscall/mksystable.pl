...
#list of non - pointer types that start with P
    % ptypes =
        ('PROCESSINFOCLASS' = > 1, 'POWER_ACTION' = > 1, 'POWER_INFORMATION_LEVEL' = > 1,
         'PKNORMAL_ROUTINE' = > 1, 'PIO_APC_ROUTINE' = > 1, 'PTIMER_APC_ROUTINE' = > 1,
         'PTHREAD_START_ROUTINE' = > 1, 'PALETTEENTRY' = > 1, 'PATHOBJ' = > 1,
         'POINT' = > 1, 'POINTL' = > 1, 'POINTFIX' = > 1, 'POINTQF' = > 1,
         'POLYTEXTW' = > 1, 'POLYPATBLT' = > 1, 'PERBANDINFO' = > 1, );

% typemap_inline =
    ('ULONG' = > 'DRSYS_TYPE_UNSIGNED_INT', 'LONG' = > 'DRSYS_TYPE_SIGNED_INT',
     'USHORT' = > 'DRSYS_TYPE_UNSIGNED_INT', 'UCHAR' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'DWORD' = > 'DRSYS_TYPE_UNSIGNED_INT', 'LCID' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'LANGID' = > 'DRSYS_TYPE_UNSIGNED_INT', 'ACCESS_MASK' = > 'DRSYS_TYPE_UNSIGNED_INT',
     ...
     'UINT' = > 'DRSYS_TYPE_UNSIGNED_INT', 'FLONG' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'ULONG_PTR' = > 'DRSYS_TYPE_UNSIGNED_INT', 'COLORREF' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'SIZE_T' = > 'DRSYS_TYPE_UNSIGNED_INT', 'WCHAR' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'LFTYPE' = > 'DRSYS_TYPE_UNSIGNED_INT', 'ROP4' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'MIX' = > 'DRSYS_TYPE_UNSIGNED_INT', 'BYTE' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'WPARAM' = > 'DRSYS_TYPE_UNSIGNED_INT', 'DWORD_PTR' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'UINT_PTR' = > 'DRSYS_TYPE_UNSIGNED_INT', 'unsigned' = > 'DRSYS_TYPE_UNSIGNED_INT',
     ...
     'TOKEN_TYPE' = > 'DRSYS_TYPE_SIGNED_INT', 'WAIT_TYPE' = > 'DRSYS_TYPE_SIGNED_INT',
     'KPROFILE_SOURCE' = > 'DRSYS_TYPE_SIGNED_INT',
     'EVENT_TYPE' = > 'DRSYS_TYPE_SIGNED_INT', 'TIMER_TYPE' = > 'DRSYS_TYPE_SIGNED_INT',
     'SECTION_INHERIT' = > 'DRSYS_TYPE_SIGNED_INT',
     'HARDERROR_RESPONSE_OPTION' = > 'DRSYS_TYPE_SIGNED_INT',
     'ARCTYPE' = > 'DRSYS_TYPE_SIGNED_INT', 'INT' = > 'DRSYS_TYPE_SIGNED_INT',
     'WORD' = > 'DRSYS_TYPE_SIGNED_INT', 'DXGI_FORMAT' = > 'DRSYS_TYPE_SIGNED_INT',
     'HLSURF_INFORMATION_CLASS' = > 'DRSYS_TYPE_SIGNED_INT',
     'LPARAM' = > 'DRSYS_TYPE_SIGNED_INT', 'GETCPD' = > 'DRSYS_TYPE_SIGNED_INT',
     'USERTHREADINFOCLASS' = > 'DRSYS_TYPE_SIGNED_INT',
     'WORKERFACTORYINFOCLASS' = > 'DRSYS_TYPE_SIGNED_INT',
     'int' = > 'DRSYS_TYPE_SIGNED_INT', 'BOOL' = > 'DRSYS_TYPE_BOOL',
     'BOOLEAN' = > 'DRSYS_TYPE_BOOL', 'HANDLE' = > 'DRSYS_TYPE_HANDLE',
     'HDC' = > 'DRSYS_TYPE_HANDLE', 'HBITMAP' = > 'DRSYS_TYPE_HANDLE',
     'HPALETTE' = > 'DRSYS_TYPE_HANDLE', 'HWND' = > 'DRSYS_TYPE_HANDLE',
     'HCOLORSPACE' = > 'DRSYS_TYPE_HANDLE', 'HBRUSH' = > 'DRSYS_TYPE_HANDLE',
     'HRGN' = > 'DRSYS_TYPE_HANDLE', 'HPEN' = > 'DRSYS_TYPE_HANDLE',
     'HFONT' = > 'DRSYS_TYPE_HANDLE', 'HSURF', = > 'DRSYS_TYPE_HANDLE', 'HDEV',
     = > 'DRSYS_TYPE_HANDLE', 'DHSURF' = > 'DRSYS_TYPE_HANDLE',
     'HUMPD' = > 'DRSYS_TYPE_HANDLE', 'HLSURF' = > 'DRSYS_TYPE_HANDLE',
     'HMENU' = > 'DRSYS_TYPE_HANDLE', 'HKL' = > 'DRSYS_TYPE_HANDLE',
     'HDESK' = > 'DRSYS_TYPE_HANDLE', 'HWINSTA' = > 'DRSYS_TYPE_HANDLE',
     'HACCEL' = > 'DRSYS_TYPE_HANDLE', 'HINSTANCE' = > 'DRSYS_TYPE_HANDLE',
     'HDWP' = > 'DRSYS_TYPE_HANDLE', 'HCURSOR' = > 'DRSYS_TYPE_HANDLE',
     'HICON' = > 'DRSYS_TYPE_HANDLE', 'HRAWINPUT' = > 'DRSYS_TYPE_HANDLE',
     'HMODULE' = > 'DRSYS_TYPE_HANDLE', 'HRSRC' = > 'DRSYS_TYPE_HANDLE',
     'HHOOK' = > 'DRSYS_TYPE_HANDLE', 'HWINEVENTHOOK' = > 'DRSYS_TYPE_HANDLE',
     'HMONITOR' = > 'DRSYS_TYPE_HANDLE', 'ATOM' = > 'DRSYS_TYPE_ATOM',
     'NTSTATUS' = > 'DRSYS_TYPE_NTSTATUS', 'PVOID' = > 'DRSYS_TYPE_POINTER',
     ...
     'TIMERPROC' = > 'DRSYS_TYPE_FUNCTION', 'HOOKPROC' = > 'DRSYS_TYPE_FUNCTION',
     'WINEVENTPROC' = > 'DRSYS_TYPE_FUNCTION',
#no targeted type
     'LDT_ENTRY' = > 'DRSYS_TYPE_STRUCT', 'BLENDFUNCTION' = > 'DRSYS_TYPE_STRUCT',
     'PALETTEENTRY' = > 'DRSYS_TYPE_STRUCT', 'SIZEL' = > 'DRSYS_TYPE_STRUCT',
     'POINT' = > 'DRSYS_TYPE_STRUCT', 'PIO_APC_ROUTINE' = > 'DRSYS_TYPE_POINTER',
     'PTIMER_APC_ROUTINE' = > 'DRSYS_TYPE_POINTER',
     'PKNORMAL_ROUTINE' = > 'DRSYS_TYPE_POINTER', );
% typemap_complex =
    ('PCSTR' = > 'DRSYS_TYPE_CSTRING', 'PCWSTR' = > 'DRSYS_TYPE_CWSTRING',
     ...
     'PORT_MESSAGE' = > 'DRSYS_TYPE_PORT_MESSAGE', 'CONTEXT' = > 'DRSYS_TYPE_CONTEXT',
     'EXCEPTION_RECORD' = > 'DRSYS_TYPE_EXCEPTION_RECORD',
     'DEVMODEW' = > 'DRSYS_TYPE_DEVMODEW', 'WNDCLASSEXW' = > 'DRSYS_TYPE_WNDCLASSEXW',
     ...
     'SERIALKEYSW' = > 'DRSYS_TYPE_SERIALKEYSW', 'SOCKADDR' = > 'DRSYS_TYPE_SOCKADDR',
     'MSGHDR' = > 'DRSYS_TYPE_MSGHDR', 'MSGBUF' = > 'DRSYS_TYPE_MSGBUF',
     'FILE_IO_COMPLETION_INFORMATION' = > 'DRSYS_TYPE_FILE_IO_COMPLETION_INFO');
% typemap_struct = ('LARGE_INTEGER' = > 'DRSYS_TYPE_LARGE_INTEGER',
...
#Nebbett has ^ NTSYSAPI, Metasploit has.*NTSYSAPI, ntuser.h has NTAPI
    next unless(/ (NTSYSAPI\s * $) | (^__kernel_entry W32KAPI) | (NTAPI\s * $) |
                (APIENTRY) /);
    $is_w32k = / W32KAPI / ;
    while (<STDIN>) {
    ...
    next if (/ ^APIENTRY\s * $ /);
#    sometimes on next line next if (/ ^Rtl /);
...
#not a real system call : just reads KUSER_SHARED_DATA
    ...
    while (<STDIN>) {
        ...
        s | //.*$||; # remove comments
            ...
            ||
            ;
#        remove comments s |\s *const(\s *) |\1 | i;
#        remove const s |\s *OPTIONAL(\s *) |\1 | i;
#        remove OPTIONAL if (/ ^\s *(VOID)\s *(, |\); |)\s *$ /)
        {
            $inout = "";
            $arg_type[$argnum] = $1;
        }
...
#we assume only one other set of parens : [eb] count
        ...
        foreach
            $a(split('_', $ann))
            {
                ...
                elsif($a eq 'opt' || #we don't care $a eq 'part') { #we assume we'll see (size,length)
#ignore annotation
                } elsif($a = ~ / ^bcount /)
                {
                    $arg_ecount[$argnum] = 0;
...
s /\r ?\n$ //;
    print "\t$argnum: $_ => "
          "$arg_inout[$argnum]:$arg_type[$argnum]:$arg_var[$argnum]\n" if ($verbose);
...
for ($i = 0; $i < $argnum; $i++) {
    ...
    my $type = $arg_type[$i];
    my $param_in_memory = ($type = ~ / ^P / || $type = ~ /\* /) &&
#    IN PVOID is usually inlined
        ($type ne 'PVOID' || $inout = ~ / OUT / || $arg_var[$i] = ~ / Buffer$ / ||
             $arg_var[$i] = ~ / Information$ /) &&
#    list of inlined types that start with P
        $type !~ / _INFORMATION_CLASS / &&!defined($ptypes { $type });
...
#                same as cap
        ...
        elsif($param_in_memory && !$is_w32k && ($type eq 'PVOID' || $type eq 'PWSTR'))
        {
