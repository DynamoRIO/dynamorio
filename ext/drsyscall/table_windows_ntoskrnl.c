...
#include "../drmf/wininc/ntexapi.h"
#include "../drmf/wininc/ntifs.h"
#include "../drmf/wininc/ntmmapi.h"
#include "../drmf/wininc/tls.h"
#include "../drmf/wininc/ktmtypes.h"
#include "../drmf/wininc/winnt_recent.h"
