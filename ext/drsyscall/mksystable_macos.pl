...
% typemap =
    ('int' = > 'DRSYS_TYPE_SIGNED_INT', 'long' = > 'DRSYS_TYPE_SIGNED_INT',
     'user_ssize_t' = > 'DRSYS_TYPE_SIGNED_INT', 'off_t' = > 'DRSYS_TYPE_SIGNED_INT',
     'int32_t' = > 'DRSYS_TYPE_SIGNED_INT', 'int64_t' = > 'DRSYS_TYPE_SIGNED_INT',
     'socklen_t' = > 'DRSYS_TYPE_SIGNED_INT', 'pid_t' = > 'DRSYS_TYPE_SIGNED_INT',
     'uid_t' = > 'DRSYS_TYPE_SIGNED_INT', 'gid_t' = > 'DRSYS_TYPE_SIGNED_INT',
     'au_asid_t' = > 'DRSYS_TYPE_SIGNED_INT', 'au_id_t' = > 'DRSYS_TYPE_SIGNED_INT',
     'key_t' = > 'DRSYS_TYPE_SIGNED_INT', 'short' = > 'DRSYS_TYPE_SIGNED_INT',
     'sem_t' = > 'DRSYS_TYPE_SIGNED_INT',
     'mach_port_name_t' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'uint32_t' = > 'DRSYS_TYPE_UNSIGNED_INT', 'uint64_t' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'u_int' = > 'DRSYS_TYPE_UNSIGNED_INT', 'u_long' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'u_int32_t' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'unsigned int' = > 'DRSYS_TYPE_UNSIGNED_INT', 'id_t' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'size_t' = > 'DRSYS_TYPE_UNSIGNED_INT', 'sigset_t' = > 'DRSYS_TYPE_UNSIGNED_INT',
     'mode_t' = > 'DRSYS_TYPE_UNSIGNED_INT', 'user_size_t' = > 'DRSYS_TYPE_SIGNED_INT',
     'user_addr_t' = > 'DRSYS_TYPE_POINTER', 'void *' = > 'DRSYS_TYPE_POINTER',
     'unsigned char *' = > 'DRSYS_TYPE_POINTER', 'void' = > 'DRSYS_TYPE_VOID',
     'caddr_t' = > 'DRSYS_TYPE_CSTRING', 'char *' = > 'DRSYS_TYPE_CSTRING',
     'char **' = > 'DRSYS_TYPE_CSTRARRAY', 'idtype_t' = > 'DRSYS_TYPE_STRUCT',
     'fhandle_t' = > 'DRSYS_TYPE_STRUCT', 'siginfo_t' = > 'DRSYS_TYPE_STRUCT',
...
% sizemap = ('user_ssize_t' = > 'ssize_t', 'user_size_t' = > 'size_t',
             'user_addr_t' = > 'void*', 'user_long_t' = > 'long',
