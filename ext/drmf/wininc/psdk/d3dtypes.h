...
typedef HRESULT(CALLBACK *LPD3DENUMTEXTUREFORMATSCALLBACK)(LPDDSURFACEDESC lpDdsd,
                                                           LPVOID lpContext);
typedef HRESULT(CALLBACK *LPD3DENUMPIXELFORMATSCALLBACK)(LPDDPIXELFORMAT lpDDPixFmt,
                                                         LPVOID lpContext);
...
public:
    ...
    _D3DTLVERTEX(const D3DVECTOR &v, float _rhw, D3DCOLOR _color, D3DCOLOR _specular,
                 float _tu, float _tv)
    {
        sx = v.x;
        sy = v.y;
...
#define D3DFVF_LVERTEX \
    (D3DFVF_XYZ | D3DFVF_RESERVED1 | D3DFVF_DIFFUSE | D3DFVF_SPECULAR | D3DFVF_TEX1)
