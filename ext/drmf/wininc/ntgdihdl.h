...
#define GDI_OBJECT_TYPE_DD_VIDEOPORT \
    0x00120000 /* Should be moved away from gdi objects */
#define GDI_OBJECT_TYPE_DD_MOTIONCOMP \
    0x00140000 /* Should be moved away from gdi objects */
