...
#undef FUNCNAME
#define FUNCNAME test_x86_64_crc32_s_asm
...
GLOBAL_LABEL(FUNCNAME:)
        ...
        RAW(f2) RAW(0f) RAW(38) RAW(f1) RAW(c0)
        RAW(f2) RAW(48) RAW(0f) RAW(38) RAW(f1) RAW(c0)
        RAW(f2) RAW(48) RAW(0f) RAW(38) RAW(f1) RAW(c0)
        RAW(f2) RAW(48) RAW(0f) RAW(38) RAW(f0) RAW(06)
        RAW(f2) RAW(0f) RAW(38) RAW(f0) RAW(06)
        /* FIXME i#3578: crc32w (%esi),%eax. */
