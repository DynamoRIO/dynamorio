...
#undef FUNCNAME
#define FUNCNAME test_sse3_s_asm
...
GLOBAL_LABEL(FUNCNAME:)
        ...
        RAW(df) RAW(88) RAW(90) RAW(90) RAW(90) RAW(90)
        RAW(db) RAW(88) RAW(90) RAW(90) RAW(90) RAW(90)
        RAW(dd) RAW(88) RAW(90) RAW(90) RAW(90) RAW(90)
