...
#undef FUNCNAME
#define FUNCNAME test_intel_regs_s_asm
...
GLOBAL_LABEL(FUNCNAME:)
        ...
        RAW(00) RAW(00)
        RAW(00) RAW(dd)
        RAW(c0) RAW(0f) RAW(ef)
        RAW(c0) RAW(0f) RAW(57)
        RAW(c0) RAW(c5) RAW(fc)
        RAW(57)
        RAW(c0) RAW(44) RAW(88) RAW(c0) RAW(66)
